...
#
# Cookbook Name:: jj-cookbook-generator
# Recipe:: cookbook.rb
#
...
# Makefile
template "#{cookbook_dir}/Makefile" do
  helpers(ChefDK::Generator::TemplateHelper)
  action :create_if_missing
end
...
# kitchen.vcenter.yml
template "#{cookbook_dir}/.kitchen.vcenter.yml" do
  source 'kitchen.vcenter.yml.erb'
  helpers(ChefDK::Generator::TemplateHelper)
  action :create_if_missing
end

# ruby-version
template "#{cookbook_dir}/.ruby-version" do
...
# envrc
template "#{cookbook_dir}/.envrc" do
  source 'envrc.erb'
  helpers(ChefDK::Generator::TemplateHelper)
  action :create_if_missing
end
